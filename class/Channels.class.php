...
class Channel extends Formulaire{
	var $titre		=	array('CHANNEL_TITRE','input',1,"Cette chaîne n'a pas de titre");
	var $auteur		=	array('CHANNEL_AUTEUR','input',1,"Cette chaîne n'a pas d'auteur");
	var $lien		=	array('CHANNEL_LIEN','textarea',1,"Cette chaîne n'a pas de lien");
